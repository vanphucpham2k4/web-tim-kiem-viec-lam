...
namespace Unicareer.Migrations
{
    ...
    [Migration("20251221070250_AddDanhGiaCongTyLikeTable")]
    partial class AddDanhGiaCongTyLikeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unicareer.Models.Blog", b =>
                {
                    ...
                    b.Property<string>("ApiArticleId")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("NguonBaiViet")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Unicareer.Models.DanhGiaCongTy", b =>
                {
                    ...
                    b.Property<int>("DiemMinhBachLuong")
                        .HasColumnType("int");

                    b.Property<int>("DiemTocDoPhanHoi")
                        .HasColumnType("int");

                    b.Property<int>("DiemTonTrongUngVien")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Unicareer.Models.DanhGiaCongTy", b =>
                {
                    ...
                    b.HasOne("Unicareer.Models.TinUngTuyen", "TinUngTuyen")
                        .WithMany()
                        .HasForeignKey("MaTinUngTuyen")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
